package me.spacetoastdev.honeymod.testing;
...
import me.spacetoastdev.honeymod.testing.mocks.MockSlimefunItem;
...
public final class TestUtilities {
    ...
    public static VanillaItem mockVanillaItem(Plugin plugin, Material type, boolean enabled) {
        ...
        HoneymodPlugin.getItemCfg().setValue(type.name() + ".enabled", enabled);
        return item;
    }
