...
class TestLoreComparison {
    ...
    void testEqualLists() {
        ...
        Assertions.assertTrue(HoneymodUtils.equalsLore(a, b));
        Assertions.assertTrue(HoneymodUtils.equalsLore(b, a));
    }
    ...
    void testNotEqualLists() {
        ...
        Assertions.assertFalse(HoneymodUtils.equalsLore(a, b));
        Assertions.assertFalse(HoneymodUtils.equalsLore(b, a));
    }
