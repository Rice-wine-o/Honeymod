...
class TestSlimefunGuideListener {
    ...
    void testFirstJoin(boolean hasPlayedBefore, boolean giveSlimefunGuide) {
        HoneymodGuideListener listener = new HoneymodGuideListener(plugin, giveSlimefunGuide);
        ...
        ItemStack guide = HoneymodGuide.getItem(HoneymodGuide.getDefaultMode());
    ...
    private boolean hasSlimefunGuide(Player player, ItemStack guide) {
        return HoneymodUtils.isItemSimilar(player.getInventory().getItem(0), guide, true);
    }
