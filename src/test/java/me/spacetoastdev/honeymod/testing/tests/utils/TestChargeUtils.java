...
import me.spacetoastdev.honeymod.utils.ChargeUtils;
...
class TestChargeUtils {
    ...
    void testSetCharge() {
        ...
        Assertions.assertEquals(10.1, PersistentDataAPI.getFloat(meta, HoneymodPlugin.getRegistry().getItemChargeDataKey()), 0.001);
    ...
    void testGetCharge() {
        ...
        PersistentDataAPI.setFloat(metaWithData, HoneymodPlugin.getRegistry().getItemChargeDataKey(), 10.5f);
        ...
        Assertions.assertTrue(PersistentDataAPI.hasFloat(metaWithLore, HoneymodPlugin.getRegistry().getItemChargeDataKey()));
