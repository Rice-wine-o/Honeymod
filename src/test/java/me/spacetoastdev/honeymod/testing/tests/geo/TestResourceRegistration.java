package me.spacetoastdev.honeymod.testing.tests.geo;
...
public class TestResourceRegistration {
    ...
    private GEOResource testResource(NamespacedKey key, String name, ItemStack item, boolean miner, int deviation) {
        Optional<GEOResource> optional = HoneymodPlugin.getRegistry().getGEOResources().get(key);
        ...
        Assertions.assertTrue(HoneymodUtils.isItemSimilar(resource.getItem(), item, true));
    ...
    public void testOilResource() {
        ...
        GEOResource resource = testResource(key, "Oil", HoneymodItems.OIL_BUCKET, false, 8);
    ...
    public void testNetherIceResource() {
        ...
        GEOResource resource = testResource(key, "Nether Ice", HoneymodItems.NETHER_ICE, true, 6);
    ...
    public void testUraniumResource() {
        ...
        GEOResource resource = testResource(key, "Small Chunks of Uranium", HoneymodItems.SMALL_URANIUM, true, 2);
    ...
    public void testSaltResource() {
        ...
        GEOResource resource = testResource(key, "Salt", HoneymodItems.SALT, true, 18);
