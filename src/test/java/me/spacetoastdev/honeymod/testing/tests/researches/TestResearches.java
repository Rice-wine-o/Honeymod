...
class TestResearches {
    ...
    void testResearchRegistration() {
        ...
        Assertions.assertTrue(HoneymodPlugin.getRegistry().getResearches().contains(research));
    ...
    void testDisabledResearch() {
        ...
        HoneymodPlugin.getRegistry().setResearchingEnabled(true);
        HoneymodPlugin.getResearchCfg().setValue(key.getNamespace() + '.' + key.getKey() + ".enabled", false);
        research.register();
    ...
    void testFreeCreativeResearch() {
        ...
        HoneymodPlugin.getRegistry().setFreeCreativeResearchingEnabled(false);
        ...
        HoneymodPlugin.getRegistry().setFreeCreativeResearchingEnabled(true);
