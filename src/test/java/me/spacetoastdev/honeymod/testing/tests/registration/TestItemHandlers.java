...
import me.spacetoastdev.honeymod.testing.mocks.MockItemHandler;
...
public class TestItemHandlers {
    ...
    public void testPublicHandler() {
        ...
        Map<Class<? extends ItemHandler>, Set<ItemHandler>> handlers = HoneymodPlugin.getRegistry().getPublicItemHandlers();
