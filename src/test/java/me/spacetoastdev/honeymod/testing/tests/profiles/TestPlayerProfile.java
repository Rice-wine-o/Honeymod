package me.spacetoastdev.honeymod.testing.tests.profiles;
...
class TestPlayerProfile {
    ...
    void testOfflinePlayer() throws InterruptedException {
        ...
        Assertions.assertEquals(profile, HoneymodPlugin.getRegistry().getPlayerProfiles().get(player.getUniqueId()));
