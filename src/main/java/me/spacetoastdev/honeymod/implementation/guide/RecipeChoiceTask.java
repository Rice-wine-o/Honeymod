 ...
 * 
 * It is used in the {@link SurvivalHoneymodGuide} for any {@link ItemStack} from Minecraft
...
class RecipeChoiceTask implements Runnable {
    ...
    public void start(@Nonnull Inventory inv) {
        ...
        inventory = inv;
        id = Bukkit.getScheduler().runTaskTimerAsynchronously(HoneymodPlugin.instance(), this, 0, UPDATE_INTERVAL).getTaskId();
    }
