 ...
 *
 */
public class EnchantmentRune extends SimpleHoneymodItem<ItemDropHandler> {
    ...
    private void addRandomEnchantment(Player p, Item rune) {
        ...
        if (optional.isPresent()) {
            ...
            if (potentialEnchantments == null) {
                HoneymodPlugin.getLocalization().sendMessage(p, "messages.enchantment-rune.fail", true);
                return;
            } else {
            ...
            if (potentialEnchantments.isEmpty()) {
                HoneymodPlugin.getLocalization().sendMessage(p, "messages.enchantment-rune.no-enchantment", true);
                return;
            }
            ...
            if (itemStack.getAmount() == 1) {
                ...
                HoneymodPlugin.runSync(() -> {
                    ...
                    if (rune.isValid() && item.isValid() && itemStack.getAmount() == 1) {
                        ...
                        HoneymodPlugin.getLocalization().sendMessage(p, "messages.enchantment-rune.success", true);
                    }
                }, 10L);
            } else {
                HoneymodPlugin.getLocalization().sendMessage(p, "messages.enchantment-rune.fail", true);
