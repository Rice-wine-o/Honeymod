...
import me.spacetoastdev.honeymod.utils.holograms.SimpleHologram;
...
public class HologramProjector extends SlimefunItem implements HologramOwner {
    ...
    private static void openEditor(Player p, Block projector) {
        ChestMenu menu = new ChestMenu(HoneymodPlugin.getLocalization().getMessage(p, "machines.HOLOGRAM_PROJECTOR.inventory-title"));
        ...
        menu.addMenuClickHandler(0, (pl, slot, item, action) -> {
            pl.closeInventory();
            HoneymodPlugin.getLocalization().sendMessage(pl, "machines.HOLOGRAM_PROJECTOR.enter-text", true);
