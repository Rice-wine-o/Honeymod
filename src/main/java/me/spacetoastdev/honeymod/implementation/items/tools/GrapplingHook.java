 ...
 *
 */
public class GrapplingHook extends SimpleHoneymodItem<ItemUseHandler> {
    ...
    public ItemUseHandler getItemHandler() {
        return e -> {
            ...
            if (!e.getClickedBlock().isPresent() && !HoneymodPlugin.getGrapplingHookListener().isGrappling(uuid)) {
                e.cancel();
                ...
                HoneymodPlugin.getGrapplingHookListener().addGrapplingHook(p, arrow, bat, state, despawnTicks.getValue(), isConsumed);
            }
        };
    }
}
