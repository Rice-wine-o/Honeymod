...
public class OreCrusher extends MultiBlockMachine {
    ...
    protected void registerDefaultRecipes(List<ItemStack> recipes) {
        ...
        recipes.add(HoneymodItems.GOLD_4K);
        recipes.add(HoneymodItems.GOLD_DUST);

        recipes.add(HoneymodItems.GOLD_6K);
        recipes.add(new SlimefunItemStack(HoneymodItems.GOLD_DUST, 2));

        recipes.add(HoneymodItems.GOLD_8K);
        recipes.add(new SlimefunItemStack(HoneymodItems.GOLD_DUST, 2));

        recipes.add(HoneymodItems.GOLD_10K);
        recipes.add(new SlimefunItemStack(HoneymodItems.GOLD_DUST, 3));

        recipes.add(HoneymodItems.GOLD_12K);
        recipes.add(new SlimefunItemStack(HoneymodItems.GOLD_DUST, 3));

        recipes.add(HoneymodItems.GOLD_14K);
        recipes.add(new SlimefunItemStack(HoneymodItems.GOLD_DUST, 4));

        recipes.add(HoneymodItems.GOLD_16K);
        recipes.add(new SlimefunItemStack(HoneymodItems.GOLD_DUST, 4));

        recipes.add(HoneymodItems.GOLD_18K);
        recipes.add(new SlimefunItemStack(HoneymodItems.GOLD_DUST, 5));

        recipes.add(HoneymodItems.GOLD_20K);
        recipes.add(new SlimefunItemStack(HoneymodItems.GOLD_DUST, 5));

        recipes.add(HoneymodItems.GOLD_22K);
        recipes.add(new SlimefunItemStack(HoneymodItems.GOLD_DUST, 6));

        recipes.add(HoneymodItems.GOLD_24K);
        recipes.add(new SlimefunItemStack(HoneymodItems.GOLD_DUST, 6));
        ...
        recipes.add(HoneymodItems.SULFATE);

        recipes.add(HoneymodItems.CARBON);
        recipes.add(new ItemStack(Material.COAL, 8));

        recipes.add(HoneymodItems.COMPRESSED_CARBON);
        recipes.add(new SlimefunItemStack(HoneymodItems.CARBON, 4));
    }
        ...
        if (state instanceof Dispenser) {
            ...
            for (ItemStack current : inv.getContents()) {
                for (ItemStack convert : RecipeType.getRecipeInputs(this)) {
                    if (convert != null && HoneymodUtils.isItemSimilar(current, convert, true)) {
                        ItemStack adding = RecipeType.getRecipeOutput(this, convert);
                        Inventory outputInv = findOutputInventory(adding, dispBlock, inv);

                        if (HoneymodUtils.canPlayerUseItem(p, adding, true)) {
                            if (outputInv != null) {
    ...
    private class DoubleOreSetting extends ItemSetting<Boolean> {
        ...
        private void apply(boolean value) {
            ...
            if (ironDust != null) {
                ironDust.setRecipeOutput(new CustomItem(HoneymodItems.IRON_DUST, value ? 2 : 1));
            }

            SlimefunItem goldDust = SlimefunItem.getByID("GOLD_DUST");
            if (goldDust != null) {
                goldDust.setRecipeOutput(new CustomItem(HoneymodItems.GOLD_DUST, value ? 2 : 1));
            }
        }
