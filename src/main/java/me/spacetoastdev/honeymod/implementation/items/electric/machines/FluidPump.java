 ...
 *
 */
public class FluidPump extends SimpleHoneymodItem<BlockTicker> implements InventoryBlock, EnergyNetComponent {
    ...
    protected void tick(@Nonnull Block b) {
        ...
        if (fluid.isLiquid() && getCharge(b.getLocation()) >= ENERGY_CONSUMPTION) {
            ...
            for (int slot : getInputSlots()) {
                if (HoneymodUtils.isItemSimilar(menu.getItemInSlot(slot), emptyBucket, true, false)) {
