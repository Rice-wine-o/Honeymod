...
public abstract class GPSTransmitter extends SimpleHoneymodItem<BlockTicker> implements EnergyNetComponent {
    ...
    public GPSTransmitter(Category category, int tier, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        ...
        registerBlockHandler(getId(), (p, b, stack, reason) -> {
            ...
            HoneymodPlugin.getGPSNetwork().updateTransmitter(b.getLocation(), owner, false);
            return true;
        });
    }
        ...
        return new BlockTicker() {
            ...
            public void tick(Block b, SlimefunItem item, Config data) {
                ...
                if (charge >= getEnergyConsumption()) {
                    HoneymodPlugin.getGPSNetwork().updateTransmitter(b.getLocation(), owner, true);
