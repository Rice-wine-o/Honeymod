    ...
    public void stomp(EntityDamageEvent fallDamageEvent) {
        ...
        for (Entity entity : player.getNearbyEntities(4, 4, 4)) {
            if (entity instanceof LivingEntity && canPush(player, (LivingEntity) entity)) {
                ...
                if (!(entity instanceof Player) || (player.getWorld().getPVP() && HoneymodPlugin.getProtectionManager().hasPermission(player, entity.getLocation(), ProtectableAction.ATTACK_PLAYER))) {
