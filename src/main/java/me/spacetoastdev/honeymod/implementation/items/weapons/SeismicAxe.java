 ...
 *
 */
public class SeismicAxe extends SimpleHoneymodItem<ItemUseHandler> implements NotPlaceable, DamageableItem {
        ...
        return e -> {
            ...
            for (int i = 2; i < blocks.size(); i++) {
                ...
                if (ground.getRelative(BlockFace.UP).getType() == Material.AIR) {
                    ...
                    block.setMetadata("seismic_axe", new FixedMetadataValue(HoneymodPlugin.instance(), "fake_block"));
                }
