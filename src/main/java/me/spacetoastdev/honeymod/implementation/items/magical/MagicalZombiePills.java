 ...
 *
 */
public class MagicalZombiePills extends SimpleHoneymodItem<EntityInteractHandler> implements NotPlaceable {
    ...
    public EntityInteractHandler getItemHandler() {
        return (e, item, offhand) -> {
            ...
            if (e.isCancelled() || !HoneymodPlugin.getProtectionManager().hasPermission(e.getPlayer(), entity.getLocation(), ProtectableAction.INTERACT_ENTITY)) {
            ...
            } else if (HoneymodPlugin.getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_16) && entity instanceof PigZombie) {
                useItem(p, item);
    ...
    private void healZombieVillager(@Nonnull ZombieVillager zombieVillager, @Nonnull Player p) {
        ...
        if (HoneymodPlugin.getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_15)) {
