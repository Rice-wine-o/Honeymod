package me.spacetoastdev.honeymod.implementation.items.altar;
 ...
 *
 */
public class AncientPedestal extends SimpleHoneymodItem<BlockDispenseHandler> {
    ...
    public AncientPedestal(Category category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, ItemStack recipeOutput) {
        ...
        SlimefunItem.registerBlockHandler(getId(), (p, b, tool, reason) -> {
            ...
            if (entity.isPresent()) {
                ...
                if (stack.isValid()) {
                    stack.removeMetadata("no_pickup", HoneymodPlugin.instance());
    ...
    public void placeItem(@Nonnull Player p, @Nonnull Block b) {
        ...
        HoneymodUtils.markAsNoPickup(entity, "altar_item");
