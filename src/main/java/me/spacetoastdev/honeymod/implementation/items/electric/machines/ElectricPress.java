...
public class ElectricPress extends AContainer implements RecipeDisplayItem {
    ...
    protected void registerDefaultRecipes() {
        addRecipe(4, new SlimefunItemStack(HoneymodItems.STONE_CHUNK, 3), new ItemStack(Material.COBBLESTONE));
        ...
        addRecipe(6, HoneymodItems.COPPER_INGOT, new CustomItem(HoneymodItems.COPPER_WIRE, 3));
        addRecipe(16, new SlimefunItemStack(HoneymodItems.STEEL_INGOT, 8), HoneymodItems.STEEL_PLATE);
        addRecipe(18, new SlimefunItemStack(HoneymodItems.REINFORCED_ALLOY_INGOT, 8), HoneymodItems.REINFORCED_PLATE);

        addRecipe(8, new ItemStack(Material.NETHER_WART), new CustomItem(HoneymodItems.MAGIC_LUMP_1, 2));
        addRecipe(10, new SlimefunItemStack(HoneymodItems.MAGIC_LUMP_1, 4), HoneymodItems.MAGIC_LUMP_2);
        addRecipe(12, new SlimefunItemStack(HoneymodItems.MAGIC_LUMP_2, 4), HoneymodItems.MAGIC_LUMP_3);

        addRecipe(10, new ItemStack(Material.ENDER_EYE), new CustomItem(HoneymodItems.ENDER_LUMP_1, 2));
        addRecipe(12, new SlimefunItemStack(HoneymodItems.ENDER_LUMP_1, 4), HoneymodItems.ENDER_LUMP_2);
        addRecipe(14, new SlimefunItemStack(HoneymodItems.ENDER_LUMP_2, 4), HoneymodItems.ENDER_LUMP_3);

        addRecipe(18, new SlimefunItemStack(HoneymodItems.TINY_URANIUM, 9), HoneymodItems.SMALL_URANIUM);
        addRecipe(24, new SlimefunItemStack(HoneymodItems.SMALL_URANIUM, 4), HoneymodItems.URANIUM);
