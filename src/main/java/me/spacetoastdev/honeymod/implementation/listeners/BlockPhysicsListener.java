...
public class BlockPhysicsListener implements Listener {
    ...
    public BlockPhysicsListener(@Nonnull HoneymodPlugin plugin) {
    ...
    public void onLiquidFlow(BlockFromToEvent e) {
        ...
        if (HoneymodTag.FLUID_SENSITIVE_MATERIALS.isTagged(block.getType())) {
            ...
            if (BlockStorage.hasBlockInfo(block)) {
                ...
                if (HoneymodPlugin.getTickerTask().isOccupiedSoon(loc)) {
                    e.setCancelled(true);
                }
            }
        }
