...
import me.spacetoastdev.honeymod.implementation.settings.TalismanEnchantment;
...
public class TalismanListener implements Listener {
    ...
    public TalismanListener(@Nonnull HoneymodPlugin plugin) {
    ...
    public void onDamageGet(EntityDamageEvent e) {
        if (e.getEntity() instanceof Player) {
            if (e.getCause() == DamageCause.LAVA) {
                Talisman.trigger(e, HoneymodItems.TALISMAN_LAVA);
            }

            if (e.getCause() == DamageCause.DROWNING) {
                Talisman.trigger(e, HoneymodItems.TALISMAN_WATER);
            }

            if (e.getCause() == DamageCause.FALL) {
                Talisman.trigger(e, HoneymodItems.TALISMAN_ANGEL);
            }

            if (e.getCause() == DamageCause.FIRE) {
                Talisman.trigger(e, HoneymodItems.TALISMAN_FIRE);
            }

            if (e.getCause() == DamageCause.ENTITY_ATTACK) {
                Talisman.trigger(e, HoneymodItems.TALISMAN_KNIGHT);
                Talisman.trigger(e, HoneymodItems.TALISMAN_WARRIOR);
            }
    ...
    private void onProjectileDamage(@Nonnull EntityDamageByEntityEvent e) {
        if (e.getDamager() instanceof Projectile && !(e.getDamager() instanceof Trident)) {
            ...
            if (Talisman.trigger(e, HoneymodItems.TALISMAN_WHIRLWIND)) {
    ...
    public void onKill(EntityDeathEvent e) {
        ...
        if (!entity.getCanPickupItems() && Talisman.trigger(e, HoneymodItems.TALISMAN_HUNTER)) {
    ...
    public void onItemBreak(PlayerItemBreakEvent e) {
        if (Talisman.trigger(e, HoneymodItems.TALISMAN_ANVIL)) {
            ...
            HoneymodPlugin.runSync(() -> inv.setItem(itemSlot, item), 1L);
        }
    }
    ...
    public void onSprint(PlayerToggleSprintEvent e) {
        if (e.isSprinting()) {
            Talisman.trigger(e, HoneymodItems.TALISMAN_TRAVELLER);
        }
    }
    ...
    public void onEnchant(EnchantItemEvent e) {
        ...
        // Magician Talisman
        MagicianTalisman talisman = (MagicianTalisman) HoneymodItems.TALISMAN_MAGICIAN.getItem();
        TalismanEnchantment enchantment = talisman.getRandomEnchantment(e.getItem(), enchantments.keySet());

        if (enchantment != null && Talisman.trigger(e, HoneymodItems.TALISMAN_MAGICIAN)) {
            /*
             * Fix #2679
        ...
        // Wizard Talisman
        if (!enchantments.containsKey(Enchantment.SILK_TOUCH) && Enchantment.LOOT_BONUS_BLOCKS.canEnchantItem(e.getItem()) && Talisman.trigger(e, HoneymodItems.TALISMAN_WIZARD)) {
    ...
    public void onExperienceReceive(PlayerExpChangeEvent e) {
        ...
        if (e.getAmount() > 0 && Talisman.trigger(e, HoneymodItems.TALISMAN_WISE)) {
            // Double-XP
    ...
    public void onBlockDropItems(BlockDropItemEvent e) {
        ...
        if (item.getType() != Material.AIR && item.getAmount() > 0 && !item.containsEnchantment(Enchantment.SILK_TOUCH)) {
            ...
            if (HoneymodTag.MINER_TALISMAN_TRIGGERS.isTagged(type)) {
                Collection<Item> drops = e.getItems();

                if (Talisman.trigger(e, HoneymodItems.TALISMAN_MINER, false)) {
                    ...
                    // Fixes #2077
                    if (doubledDrops) {
                        Talisman talisman = HoneymodItems.TALISMAN_MINER.getItem(Talisman.class);
    ...
    public void onBlockBreak(BlockBreakEvent e) {
        if (HoneymodTag.CAVEMAN_TALISMAN_TRIGGERS.isTagged(e.getBlock().getType())) {
            Talisman.trigger(e, HoneymodItems.TALISMAN_CAVEMAN);
        }
    }
