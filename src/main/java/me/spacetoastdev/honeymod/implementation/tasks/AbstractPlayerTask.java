...
abstract class AbstractPlayerTask implements Runnable {
    ...
    public void schedule(long delay) {
        setID(Bukkit.getScheduler().scheduleSyncDelayedTask(HoneymodPlugin.instance(), this, delay));
    }

    public void scheduleRepeating(long delay, long interval) {
        setID(Bukkit.getScheduler().scheduleSyncRepeatingTask(HoneymodPlugin.instance(), this, delay, interval));
    }
