 ...
 * that are not necessarily a dependency or a {@link HoneymodAddon}.
 * 
...
public class IntegrationsManager {
    ...
    /**
     * This is our instance of {@link HoneymodPlugin}.
     */
     ...
     * 
     * @param plugin
     *            Our instance of {@link HoneymodPlugin}
     */
    public IntegrationsManager(@Nonnull HoneymodPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    private void load(@Nonnull String pluginName, @Nonnull Consumer<Plugin> consumer) {
        ...
        if (integration != null && integration.isEnabled()) {
            ...
            HoneymodPlugin.logger().log(Level.INFO, "Hooked into Plugin: {0} v{1}", new Object[] { pluginName, version });
