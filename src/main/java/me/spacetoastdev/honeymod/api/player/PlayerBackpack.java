...
/**
 * This class represents the instance of a {@link HoneymodBackpack} that is ready to
 * be opened.
 * 
 * It holds an actual {@link Inventory} and represents the backpack on the
 * level of an individual {@link ItemStack} as opposed to the class {@link HoneymodBackpack}.
 * 
