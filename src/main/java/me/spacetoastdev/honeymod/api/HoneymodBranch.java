...
public enum HoneymodBranch {
    ...
    HoneymodBranch(@Nonnull String name, boolean official) {
        ...
        if (!PatternUtils.ASCII.matcher(name).matches()) {
            throw new IllegalStateException("The HoneymodBranch enum contains ILLEGAL CHARACTERS. DO NOT TRANSLATE THIS FILE.");
        }
    }

    /**
     * This returns the name of this {@link HoneymodBranch}. The name is just a more readable
     * version of the enum constant.
     * 
     * @return The name of this {@link HoneymodBranch}
     */
    @Nonnull
    ...
    /**
     * This method returns whether this {@link HoneymodBranch} is considered official.
