...
public class ItemSetting<T> {
    ...
    public void load(@Nonnull SlimefunItem item) {
        ...
        HoneymodPlugin.getItemCfg().setDefaultValue(item.getId() + '.' + getKey(), getDefaultValue());
        Object configuredValue = HoneymodPlugin.getItemCfg().getValue(item.getId() + '.' + getKey());
