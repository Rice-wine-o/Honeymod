 ...
 * {@code /hm ...} and is followed by the name of this {@link SubCommand}.
 * 
...
public abstract class SubCommand {
    ...
    protected final HoneymodPlugin plugin;
    protected final HoneymodCommand cmd;

    private final String name;
    private final boolean hidden;

    @ParametersAreNonnullByDefault
    protected SubCommand(HoneymodPlugin plugin, HoneymodCommand cmd, String name, boolean hidden) {
        this.plugin = plugin;
        this.cmd = cmd;
    ...
    public String getDescription(@Nonnull CommandSender sender) {
        if (sender instanceof Player) {
            return HoneymodPlugin.getLocalization().getMessage((Player) sender, getDescription());
        } else {
            return HoneymodPlugin.getLocalization().getMessage(getDescription());
        }
    }
