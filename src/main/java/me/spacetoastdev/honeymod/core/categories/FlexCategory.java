package me.spacetoastdev.honeymod.core.categories;
...
/**
 * A {@link FlexCategory} is a {@link Category} inside the {@link HoneymodGuide} that can
...
public abstract class FlexCategory extends Category {
     ...
     * @param layout
     *            The {@link HoneymodGuideMode} in which this {@link FlexCategory} is viewed
     * 
     * @return Whether to display this {@link FlexCategory}
     */
    @ParametersAreNonnullByDefault
    public abstract boolean isVisible(Player p, PlayerProfile profile, HoneymodGuideMode layout);
     ...
     * @param layout
     *            The current {@link HoneymodGuideMode}
     */
    public abstract void open(Player p, PlayerProfile profile, HoneymodGuideMode layout);
