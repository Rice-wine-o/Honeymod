package me.spacetoastdev.honeymod.core;
...
import me.spacetoastdev.honeymod.implementation.guide.CheatSheetHoneymodGuide;
 ...
 *
 */
public final class HoneymodRegistry {
    ...
    private final Map<HoneymodGuideMode, HoneymodGuideImplementation> guides = new EnumMap<>(HoneymodGuideMode.class);
    ...
    public void load(@Nonnull HoneymodPlugin plugin, @Nonnull Config cfg) {
        ...
        guides.put(HoneymodGuideMode.CHEAT_MODE, new CheatSheetHoneymodGuide());
    ...
    /**
     * This returns the corresponding {@link HoneymodGuideImplementation} for a certain
     * {@link HoneymodGuideMode}.
     * <p>
     * This mainly only exists for internal purposes, if you want to open a certain section
     * using the {@link HoneymodGuide}, then please use the static methods provided in the
     * {@link HoneymodGuide} class.
     * 
     * @param mode
     *            The {@link HoneymodGuideMode}
     * 
     * @return The corresponding {@link HoneymodGuideImplementation}
     */
    @Nonnull
    public HoneymodGuideImplementation getHoneymodGuide(@Nonnull HoneymodGuideMode mode) {
