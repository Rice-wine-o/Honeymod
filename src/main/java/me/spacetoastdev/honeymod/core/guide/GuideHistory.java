...
public class GuideHistory {
    ...
    /**
     * Retrieves the last page in the {@link HoneymodGuide} that was visited by a {@link Player}.
     ...
     * 
     * @param guide
     *            The {@link HoneymodGuideImplementation} to use
     */
    public void openLastEntry(@Nonnull HoneymodGuideImplementation guide) {
     ...
     *            The {@link HoneymodGuideImplementation} to use
     */
    public void goBack(@Nonnull HoneymodGuideImplementation guide) {
        GuideEntry<?> entry = getLastEntry(true);
        open(guide, entry);
    }

    private <T> void open(@Nonnull HoneymodGuideImplementation guide, @Nullable GuideEntry<T> entry) {
        if (entry == null) {
