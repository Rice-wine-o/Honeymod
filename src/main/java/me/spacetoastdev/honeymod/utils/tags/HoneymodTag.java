package me.spacetoastdev.honeymod.utils.tags;
 ...
 *
 */
public enum HoneymodTag implements Tag<Material> {
    ...
    /**
     * This {@link HoneymodTag} holds all surfaces for the {@link ClimbingPick}.
     ...
     */
    private static final Map<String, HoneymodTag> nameLookup = new HashMap<>();

    /**
     * Speed up lookups by caching the values instead of creating a new array
     * on every method call.
     */
    private static final HoneymodTag[] valuesCache = values();

    static {
        for (HoneymodTag tag : valuesCache) {
    ...
    /**
     * This constructs a new {@link HoneymodTag}.
     * The {@link NamespacedKey} will be automatically inferred using
     * {@link HoneymodPlugin} and {@link #name()}.
     */
    HoneymodTag() {
        key = new NamespacedKey(HoneymodPlugin.instance(), name().toLowerCase(Locale.ROOT));
    }

    /**
     * This method reloads this {@link HoneymodTag} from our resources directory.
     *
     * @throws TagMisconfigurationException
     *             This is thrown whenever a {@link HoneymodTag} could not be parsed properly
     */
    ...
    /**
     * This method reloads every single {@link HoneymodTag} from the resources directory.
     * It is equivalent to running {@link #reload()} on every single {@link HoneymodTag} manually.
     *
     * Do keep in mind though that any misconfigured {@link HoneymodTag} will abort the entire
     * method and throw a {@link TagMisconfigurationException}. So one faulty {@link HoneymodTag}
     * will stop the reloading process.
     *
     * @throws TagMisconfigurationException
     *             This is thrown if one of the {@link HoneymodTag SlimefunTags} could not be parsed correctly
     */
    ...
    /**
     * This returns a {@link Set} of {@link Tag Tags} which are children of this {@link HoneymodTag},
     * these can be other {@link HoneymodTag SlimefunTags} or regular {@link Tag Tags}.
     *
    ...
    /**
     * This method returns an Array representation for this {@link HoneymodTag}.
     *
    ...
    /**
     * This returns a {@link Stream} of {@link Material Materials} for this {@link HoneymodTag}.
     *
     ...
     *
     * @return The {@link HoneymodTag} or null if it does not exist.
     */
    @Nullable
    public static HoneymodTag getTag(@Nonnull String value) {
